...
// Write a program that declares such a structure and creates a CandyBar
// variable called snack,
...
int main() {
  ...
  cout << "The " << snack.name << " snack weights " << snack.weight << " grams "
       << "and gives you " << snack.calories << " calories." << endl;
